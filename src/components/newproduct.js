        ...
        <div>
          {this.state.admin ? (
            <div>
              ...
              <input
                placeholder="image1"
                onChange={e => this.addImage1(e.target.value)}
              />
              <input
                placeholder="image2"
                onChange={e => this.addImage2(e.target.value)}
              />
              <input
                placeholder="name"
              ...
              <input
                placeholder="stock"
                onChange={e => this.addStock(e.target.value)}
              />
              <button
                onClick={() =>
                  this.createProduct({
            ...
            <div>
              <h6>UNAUTHORIZED: Please Login Below</h6> <Footer />
            </div>
          )}
        </div>
      </div>
