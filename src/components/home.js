        ...
        return (
            <div>
                ...
                <header className='head-desk'>
                    <img className='bogo-desk' src="http://res.cloudinary.com/kvge/image/upload/v1525658069/logo-3-KVGE-whiteshadow.png" alt="bogo"/>
                </header>
                <div className='time-desk'>
                    {time}
                </div>
                <nav className='desktop'>
                    <ul>
                    <li><Link to='/lookbook' ><button className='btn'>Spring/Summer 2018 Lookbook</button></Link></li>
                    <li><Link to='/shop'><button className='btn'>Shop</button></Link></li>
                    <li><Link to='/about'><button className='btn'>About</button></Link></li>
                    <li><button className='btn'>Contact</button></li>
                    <li><a href="https://www.facebook.com/kvgebrand"><button className='btn'>Facebook</button></a></li>
                    <li><a href="https://www.instagram.com/kvgebrand"><button className='btn'>Instagram</button></a></li>
                    <li><a href="https://www.twitter.com/kvgebrand"><button className='btn'>Twitter</button></a></li>
                    </ul>                
                </nav>
                </div>            
                <div>
